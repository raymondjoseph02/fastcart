    ...
    <div className="bg-gray-50 pb-19">
      <h1 className="mt-8 font-bold text-xl sm:text-2xl">Knowledge Base</h1>
        ...
        <div className="border-t border-gray-200 mt-8 text-center">
            <h2 className="mt-9 font-bold text-gray-300 text-2xl">Still Need Help?</h2>
            <p className="mt-2 text-base text-gray-100">Get in touch with us and we will be happy to help you out!</p>
            <button className="mt-7 h-10 w-43 bg-primary-200 rounded-md text-white">Contact Support</button>
        </div>
    </div>
  )
}
