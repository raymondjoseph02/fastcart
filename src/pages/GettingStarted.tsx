...
function GettingStarted() {
  return (
    <div className="bg-gray-50 flex gap-8">
      <div className="max-w-90 hidden sm:block">
        ...
        <p className="h-11 w-full bg-primary-300 rounded-md flex items-center px-5 text-white">Introduction to Product</p>
        <p className="h-11 w-full flex items-center px-5">Tutorials for Beginners</p>
        <p className="h-11 w-full flex items-center px-5">Moving to Bolt System</p>
        <p className="h-11 w-full flex items-center px-5">Accessibility</p>
        <p className="h-11 w-full flex items-center px-5">Content Management</p>
        <p className="h-11 w-full flex items-center px-5">Generating Reports</p>
        </div>
      </div>
