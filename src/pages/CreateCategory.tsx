        ...
        <div className="flex flex-col justify-between gap-4 xs:gap-2 xs:items-center xs:flex-row">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="h-10 py-2 text-base font-normal leading-6 rounded w-[6.31rem] border text-primary-200 bg-white border-primary-150 hover:text-primary-200/80 hover:bg-[#ffffff]/50 hover:border-[#b6b8c3] transition-colors ease-in-out duration-300"
            >
              Cancel
            </button>
            <button
              onClick={handleSave}
              className="h-10 py-2 text-base font-normal leading-6 text-white rounded bg-primary-200 w-[5.37rem] hover:bg-[#1e5effe8] transition-colors ease-in-out duration-300"
            >
              Save
            </button>
          </div>
