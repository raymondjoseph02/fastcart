...
const TopProducts: React.FC = () => {
  return (
    <div className="w-[33.75rem] h-[24.75rem] shadow-bg-auth rounded-md p-7 border border-gray-50">
      <h2 className="text-base mb-5 text-gray-300 font-bold">Top Products by Units Sold</h2>
      <table className="w-full text-sm text-left">
        <thead>
          <tr className="text-gray-100 border-b-2 border-gray-200 h-11 font-normal justify-between">
